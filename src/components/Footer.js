...
const Footer = () => {
  return (
    <div className="mt-auto flex items-center justify-between lg:justify-center xl:justify-end py-2 xl:py-3.5 px-5 md:px-8 w-full bg-gray-50 dark:bg-gray-900 transition">
